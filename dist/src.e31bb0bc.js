...
var $author$project$Main$TakingNotes = {$: 'TakingNotes'};
var $author$project$Main$flashcardDecoder = A4(
	$elm$json$Json$Decode$map3,
	F3(
		function (id, concept, definition) {
			return {concept: concept, definition: definition, id: id};
		}),
	A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'concept', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'definition', $elm$json$Json$Decode$string));
var $elm$json$Json$Decode$oneOf = _Json_oneOf;
var $author$project$Main$flagsDecoder = $elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			$elm$json$Json$Decode$list($author$project$Main$flashcardDecoder)
		]));
...
var $author$project$Main$init = F3(
	function (flags, _v0, key) {
		var definition = 'A purely functional programming language that compiles to JavaScript';
		var decodeResult = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$flagsDecoder, flags);
		var concept = 'Elm';
		var _v1 = function () {
			if (decodeResult.$ === 'Ok') {
				var flashcards = decodeResult.a;
				return _Utils_Tuple2($author$project$Main$TakingNotes, flashcards);
			} else {
		...
		return _Utils_Tuple2(
			{
				...
				flashcardId: 1 + A3(
					...
					A2(
						...
						modelFlashcards)),
				flashcards: A2($elm$core$Result$withDefault, _List_Nil, decodeResult),
				key: key,
...
var $author$project$Main$encodeFlashcard = function (flashcard) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				$elm$json$Json$Encode$int(flashcard.id)),
				_Utils_Tuple2(
				'concept',
				$elm$json$Json$Encode$string(flashcard.concept)),
				_Utils_Tuple2(
				'definition',
				$elm$json$Json$Encode$string(flashcard.definition))
			]));
};
var $author$project$Main$exportFlashcardsJson = _Platform_outgoingPort('exportFlashcardsJson', $elm$core$Basics$identity);
var $author$project$Main$exportFlashcards = function (model) {
	return $author$project$Main$exportFlashcardsJson(
		A2($elm$json$Json$Encode$list, $author$project$Main$encodeFlashcard, model.flashcards));
};
var $author$project$Main$FlashcardQuiz = F4(
	function (a, b, c, d) {
		return {$: 'FlashcardQuiz', a: a, b: b, c: c, d: d};
	});
var $author$project$Main$GotFocusResult = function (a) {
	return {$: 'GotFocusResult', a: a};
};
var $author$project$NonEmpty$NonEmpty = F2(
	function (a, b) {
		return {$: 'NonEmpty', a: a, b: b};
	});
var $author$project$Main$QuizComplete = F2(
	function (a, b) {
		return {$: 'QuizComplete', a: a, b: b};
	});
...
var $author$project$NonEmpty$annotate = function (a) {
	return A2(
...
var $author$project$NonEmpty$annotateList = function (list) {
	if (!list.b) {
		...
		return A3(
			...
			$elm$core$List$cons,
			$author$project$NonEmpty$annotate(head),
			$author$project$NonEmpty$annotateList(tail));
	}
};
var $author$project$NonEmpty$annotateNonEmpty = function (_v0) {
	var head = _v0.a;
	var tail = _v0.b;
	return A3(
		$elm$random$Random$map2,
...
var $author$project$NonEmpty$append = F2(
	function (list, x) {
		if (!list.b) {
			return A2($author$project$NonEmpty$NonEmpty, x, _List_Nil);
		} else {
			var head = list.a;
			var tail = list.b;
			return A2(
...
var $author$project$NonEmpty$extend = F2(
	function (_v0, list) {
		var head = _v0.a;
		var tail = _v0.b;
		return A2(
...
var $author$project$NonEmpty$insertSorted = F4(
	function (f, x, left, right) {
		insertSorted:
		while (true) {
			if (!right.b) {
				return A2(
					$author$project$NonEmpty$extend,
					A2($author$project$NonEmpty$append, left, x),
					right);
			} else {
				var head = right.a;
				var tail = right.b;
				if (_Utils_cmp(
					...
					left = $temp$left;
					right = $temp$right;
					continue insertSorted;
				}
			}
		}
	});
var $elm$core$List$sortBy = _List_sortBy;
var $author$project$NonEmpty$sortBy = F2(
	function (f, _v0) {
		var head = _v0.a;
		var tail = _v0.b;
		var sortedTail = A2($elm$core$List$sortBy, f, tail);
		return A4($author$project$NonEmpty$insertSorted, f, head, sortedTail, _List_Nil);
	});
var $author$project$NonEmpty$shuffle = function (list) {
	return A2(
		$elm$random$Random$map,
		...
		A2(
			$elm$random$Random$map,
			$author$project$NonEmpty$sortBy(
				function ($) {
					return $.x;
				}),
			$author$project$NonEmpty$annotateNonEmpty(list)));
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'AddFlashcardClicked':
				var newFlashcardId = model.flashcardId + 1;
				var flashcard = {concept: model.concept, definition: model.definition, id: model.flashcardId};
				var flashcards = A2($elm$core$List$cons, flashcard, model.flashcards);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{flashcardId: newFlashcardId, flashcards: flashcards}),
					$elm$core$Platform$Cmd$none);
			case 'ConceptChanged':
				var string = msg.a;
				return _Utils_Tuple2(
			...
			case 'DefinitionChanged':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{definition: string}),
					$elm$core$Platform$Cmd$none);
			case 'StartQuizClicked':
				var flashcards = msg.a;
				var _v1 = A2(
					$elm$random$Random$step,
					$author$project$NonEmpty$shuffle(flashcards),
					model.seed);
				var choices = _v1.a;
				var seed1 = _v1.b;
				var _v2 = A2(
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							seed: seed2,
							state: A4($author$project$Main$FlashcardQuiz, questions, choices, 0, 0)
						}),
					A2(
						$elm$core$Task$attempt,
						$author$project$Main$GotFocusResult,
						$elm$browser$Browser$Dom$focus('concept')));
			case 'GotFocusResult':
				var result = msg.a;
				if (result.$ === 'Ok') {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					...
					return _Utils_Tuple2(
						model,
						$author$project$Main$debug('element does not exist: \'' + (id + '\'')));
				}
			case 'EndQuizClicked':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{state: $author$project$Main$TakingNotes}),
					$elm$core$Platform$Cmd$none);
			case 'DefinitionClicked':
				var choice = msg.a;
				var _v4 = model.state;
				if (_v4.$ === 'FlashcardQuiz') {
					var _v5 = _v4.a;
					var question = _v5.a;
					var questions = _v5.b;
					var choices = _v4.b;
					var numCorrect = _v4.c;
					var numAsked = _v4.d;
					var newNumCorrect = _Utils_eq(choice.id, question.id) ? (numCorrect + 1) : numCorrect;
					var _v6 = A2(
						$elm$random$Random$step,
						$author$project$NonEmpty$shuffle(choices),
						model.seed);
					var newChoices = _v6.a;
					var newSeed = _v6.b;
					var newState = function () {
						if (questions.b) {
							var nextQuestion = questions.a;
							var remainingQuestions = questions.b;
							return A4(
								$author$project$Main$FlashcardQuiz,
								A2($author$project$NonEmpty$NonEmpty, nextQuestion, remainingQuestions),
								newChoices,
								newNumCorrect,
								numAsked + 1);
						} else {
							return A2($author$project$Main$QuizComplete, newNumCorrect, numAsked + 1);
						}
					}();
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{seed: newSeed, state: newState}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
			case 'QuizCompleteOkClicked':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{state: $author$project$Main$TakingNotes}),
			...
			case 'ExportClicked':
				return _Utils_Tuple2(
					model,
					$author$project$Main$exportFlashcards(model));
			default:
				var flashcard = msg.a;
				var newFlashcards = A2(
					$elm$core$List$filter,
					A2(
						$elm$core$Basics$composeL,
						$elm$core$Basics$neq(flashcard.id),
						function ($) {
							return $.id;
						}),
					model.flashcards);
...
var $author$project$Main$updateAndExport = F2(
	function (msg, model) {
		...
		return _Utils_Tuple2(
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						$author$project$Main$exportFlashcards(newModel),
						cmd
					])));
	});
var $author$project$Main$QuizCompleteOkClicked = {$: 'QuizCompleteOkClicked'};
var $elm$html$Html$h1 = _VirtualDom_node('h1');
var $elm$html$Html$sub = _VirtualDom_node('sub');
var $author$project$Main$viewActionBar = function (items) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('action-bar-container')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('action-bar')
					]),
				items)
			]));
};
var $elm$html$Html$pre = _VirtualDom_node('pre');
var $author$project$Main$viewFatal = function (err) {
	return _List_fromArray(
		[
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$id('fatal-error')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('A fatal error occurred')
						])),
					A2(
					$elm$html$Html$p,
					_List_Nil,
...
var $author$project$Main$EndQuizClicked = {$: 'EndQuizClicked'};
...
var $author$project$Main$DefinitionClicked = function (a) {
	return {$: 'DefinitionClicked', a: a};
};
var $author$project$Main$viewFlashcardQuizChoice = function (flashcard) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('quiz-definition'),
				$elm$html$Html$Events$onClick(
				$author$project$Main$DefinitionClicked(flashcard))
			]),
		_List_fromArray(
			[
				$elm$html$Html$text(flashcard.definition)
			]));
};
var $author$project$Main$viewFlashcardQuiz = F4(
	function (_v0, flashcards, numCorrect, numAsked) {
		var question = _v0.a;
		return _List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('quiz-header'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Which is the correct definition of '),
								A2(
								$elm$html$Html$strong,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text(question.concept)
									])),
								$elm$html$Html$text('?')
							])),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('quiz-results')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								$elm$core$String$fromInt(numCorrect)),
								$elm$html$Html$text('/'),
								$elm$html$Html$text(
								$elm$core$String$fromInt(numAsked)),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('choices-container')
					]),
				A2(
					$elm$core$List$map,
					$author$project$Main$viewFlashcardQuizChoice,
					$author$project$NonEmpty$toList(flashcards))),
				$author$project$Main$viewActionBar(
				_List_fromArray(
					[
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Main$EndQuizClicked)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('End Quiz')
							]))
					]))
			]);
	});
var $author$project$Main$AddFlashcardClicked = {$: 'AddFlashcardClicked'};
var $author$project$Main$ConceptChanged = function (a) {
	return {$: 'ConceptChanged', a: a};
};
var $author$project$Main$DefinitionChanged = function (a) {
	return {$: 'DefinitionChanged', a: a};
};
var $author$project$Main$ExportClicked = {$: 'ExportClicked'};
var $author$project$Main$StartQuizClicked = function (a) {
	return {$: 'StartQuizClicked', a: a};
};
...
var $author$project$NonEmpty$fromList = function (list) {
	if (list.b) {
		...
		var tail = list.b;
		return $elm$core$Maybe$Just(
			A2($author$project$NonEmpty$NonEmpty, head, tail));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Main$DeleteFlashcardClicked = function (a) {
	return {$: 'DeleteFlashcardClicked', a: a};
};
...
var $joshforisha$elm_html_entities$Html$Entity$times = $joshforisha$elm_html_entities$Html$Entity$entity(
	_List_fromArray(
		[215]));
var $author$project$Main$viewFlashcard = function (flashcard) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('flashcard')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flashcard-concept')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(flashcard.concept)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flashcard-definition')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(flashcard.definition)
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('flashcard-delete'),
						$elm$html$Html$Events$onClick(
						$author$project$Main$DeleteFlashcardClicked(flashcard))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text($joshforisha$elm_html_entities$Html$Entity$times)
					]))
			]));
};
var $author$project$Main$viewTakingNotes = function (model) {
	var ok = ($elm$core$String$length(model.concept) > 0) && (($elm$core$String$length(model.definition) > 0) && A2(
		$elm$core$List$all,
		A2(
			$elm$core$Basics$composeR,
			function ($) {
			...
			$elm$core$Basics$neq(model.concept)),
		model.flashcards));
	var onSubmit = ok ? $author$project$Main$AddFlashcardClicked : $author$project$Main$NoOp;
	return _Utils_ap(
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('flashcard-form-container')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onSubmit($author$project$Main$AddFlashcardClicked),
								$elm$html$Html$Attributes$id('flashcard-form')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Add a Flashcard')
											]))
									])),
								A2(
								$elm$html$Html$div,
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onInput($author$project$Main$ConceptChanged),
										$elm$html$Html$Attributes$value(model.concept),
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onInput($author$project$Main$DefinitionChanged),
										$elm$html$Html$Attributes$value(model.definition)
									]),
								_List_Nil),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$id('add-flashcard-button'),
										$elm$html$Html$Attributes$disabled(!ok)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Add Flashcard')
									]))
							]))
					]))
			]),
		function () {
			var _v0 = $author$project$NonEmpty$fromList(model.flashcards);
			if (_v0.$ === 'Just') {
				...
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick(
										$author$project$Main$StartQuizClicked(flashcards))
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$ExportClicked)
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Export Quiz')
									]))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('flashcards-container')
							]),
						A2($elm$core$List$map, $author$project$Main$viewFlashcard, model.flashcards))
					]);
			} else {
				return _List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('No Flashcards')
							]))
					]);
			}
		}());
	...
	return {
		body: function () {
			...
			switch (_v0.$) {
				case 'Fatal':
					var err = _v0.a;
					return $author$project$Main$viewFatal(err);
				case 'TakingNotes':
					return $author$project$Main$viewTakingNotes(model);
				case 'FlashcardQuiz':
					var questions = _v0.a;
					var choices = _v0.b;
					var numCorrect = _v0.c;
					var numAsked = _v0.d;
					return A4($author$project$Main$viewFlashcardQuiz, questions, choices, numCorrect, numAsked);
				default:
					var numCorrect = _v0.a;
					var numAsked = _v0.b;
					return _List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$id('quiz-complete-dialog')
								]),
							_List_fromArray(
								[
									A2(
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Quiz Complete')
										])),
									A2(
									$elm$html$Html$sub,
									_List_Nil,
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$Events$onClick($author$project$Main$QuizCompleteOkClicked)
										]),
									_List_fromArray(
										[
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{init: $author$project$Main$init, onUrlChange: $author$project$Main$onUrlChange, onUrlRequest: $author$project$Main$onUrlRequest, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$updateAndExport, view: $author$project$Main$view});
_Platform_export({'Main':{'init':$author$project$Main$main($elm$json$Json$Decode$value)({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.Flashcard":{"args":[],"type":"{ concept : String.String, definition : String.String, id : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"AddFlashcardClicked":[],"ConceptChanged":["String.String"],"DefinitionChanged":["String.String"],"StartQuizClicked":["NonEmpty.NonEmpty Main.Flashcard"],"GotFocusResult":["Result.Result Browser.Dom.Error ()"],"EndQuizClicked":[],"DefinitionClicked":["Main.Flashcard"],"QuizCompleteOkClicked":[],"ExportClicked":[],"DeleteFlashcardClicked":["Main.Flashcard"]}},"Browser.Dom.Error":{"args":[],"tags":{"NotFound":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"NonEmpty.NonEmpty":{"args":["a"],"tags":{"NonEmpty":["a","List.List a"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"List.List":{"args":["a"],"tags":{}}}}})}});
...
var json = window.localStorage.getItem("flashcards");
var flashcardsObject = json === null ? [] : JSON.parse(json);
...
},{"./Main.elm":"Main.elm"}],"../../../../../usr/local/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
